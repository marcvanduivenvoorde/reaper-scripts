...
function bounceInPlace.bounce(mono)
    ...
    if mono == true then
        reaper.Main_OnCommandEx(40789, 0, 0) -- render stereo stem of bus track
    else
...
function bounceInPlace.mono()
    bounceInPlace.bounce(true)
end

function bounceInPlace.stereo(bounceTrack)
    bounceInPlace.bounce(false)
end

return bounceInPlace
